    ...
    <div class="row ">
        ...
        <div class="row mt-2">
                ...
                <div class="border p-3 rounded shadow-sm bg-white">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <div class="d-flex align-items-center">
                            ...
                            <h5 class="m-0  text-black-50 text-uppercase font-size-13">Nombre de matériels</h5>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <div class="d-flex align-items-center">
                            <div class="me-2 bg-secondary rounded-circle"
                                 style="width: 10px;height: 10px;"></div>
                            <h5 class="m-0  text-black-50 text-uppercase font-size-13">Catégorie des matériels</h5>
                        </div>
                    </div>
                    <div class="d-flex align-items-end">
                        <h4 style="width: 100%"
            ...
            <div class=" col-md-6 col-12 mt-3">
                <div class="card">
                    <div class="card-body">
                        <h5>Les Categories de matériels</h5>
                        <hr>
...
@push('scripts')
    ...
    <script>
        ...
        const __dataTable_ajax_link = "{{ route('tableau_bord.category') }}";
